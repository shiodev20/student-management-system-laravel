...
const assignStudentInputs = document.querySelectorAll('#studentAssign input[type=checkbox]')
const assignStudentBtn = document.querySelector('#assignStudentButton')
...
const firstReportYearSelect = document.querySelector('#reportClassroomSubjectForm select#year')
const firstReportClassroomSelect = document.querySelector('#reportClassroomSubjectForm select#classroom')
const firstReportClassroomOptions = document.querySelectorAll('#reportClassroomSubjectForm select#classroom option')
